...
def explore_arena(mc, sensors, box_tracker, landing_watch):
    ...
    for row in range(number_of_rows):
        if row == 0:
            ...
            box_found = sweep_row(
                mc, sensors, box_tracker, landing_watch, direction,
            ...
            box_found = sweep_row(mc, sensors, box_tracker, landing_watch, direction)
        ...
        advanced, box_found = advance_row(mc, sensors, box_tracker, landing_watch)
